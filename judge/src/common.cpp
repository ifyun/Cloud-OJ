...
static auto short_options = "c:r:t:m:o:w:d:u:";

int get_args(const int argc, char* argv[], char* cmd, char workdir[], char datadir[], Config& config)
{
    int opt;
    int index = 0;
    int count = 0;
