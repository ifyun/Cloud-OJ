...
public class ProblemController implements CRUDController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "keyword", value = "题目关键字"),
    ...
    @ApiOperation(value = "获取单个题目的详细信息", notes = "只能获取开放的题目")
    ...
    @ApiImplicitParam(name = "problem", value = "题目", required = true)
    @ApiResponses({
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "problemId", required = true, example = "1001"),
            @ApiImplicitParam(name = "enable", value = "是否开放", required = true, example = "true")
    })
    @ApiResponses({
    ...
    @ApiImplicitParam(name = "problem", required = true)
    @ApiResponses({
